...
export default function Edit({ auth, tenant }) {
    const { data, setData, put, errors } = useForm({
        id: tenant.id || "",
        lead_contact_name: tenant.lead_contact_name || "",
        lead_contact_email: tenant.lead_contact_email || "",
    });
                                ...
                                <div className="flex flex-col">
                                    <div className="mb-4">
                                        ...
                                        <input
                                            type="text"
                                            disabled="true"
                                            className="bg-gray-100 text-gray-900 cursor-not-allowed w-full px-4 py-2"
                                            label="id"
                                            name="id"
                                            errors={errors.id}
                                            value={data.id}
